                ...
                <section id="c">
                    ...
                    <table method="post" border="1" class="table table-hover">
                        ...
                        <tr>
                            ...
                            <td><textarea class="description" name="desc2" required></textarea></td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td><textarea class="description" name="desc3" required></textarea></td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td><textarea class="description" name="desc4" required></textarea></td>
                            <td>
